...
orders.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!userId)
            return res.status(400).json({ err: 'Autenticacion fallida, usuario no encontrado' });
        ...
        orders.map((ordersData) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (!namePlate)
                return res.status(400).json({ err: 'Plato no encontrado, orden no creada' });
...
orders.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const ordenesMapeadas = yield Promise.all(ordenesConClientes.map(({ id, id_orden, id_platos, cantidad, precio_total, id_cliente, fecha_creacion, menu }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const filterValues = ingredientes.map((data) => {
                ...
                if ((_a = data.ordenes_ingredientes_ingrediente) === null || _a === void 0 ? void 0 : _a.ingrediente) {
                    return Object.assign(Object.assign({}, data.ordenes_ingredientes_ingrediente), data.ordenes_ingredientes_titulos);
                }
