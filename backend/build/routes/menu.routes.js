...
app.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const menu = yield Promise.all(menuPrisma.map((data) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (variants.length > 0) {
                return Object.assign(Object.assign({}, data), { name: data.nombre, description: data.descripcion, category: data.categorias.categoria, variants });
            }
            if (ingredientesOpcionales || extras) {
                return Object.assign(Object.assign({}, data), { name: data.nombre, description: data.descripcion, category: data.categorias.categoria, price: Number(data.precio), ingredients,
                    extras, variants: null });
            }
        })));
